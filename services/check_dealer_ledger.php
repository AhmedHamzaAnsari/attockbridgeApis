    ...
    if ($pass == $access_key) {
        ...
        while ($user = $result1->fetch_assoc()) {
           ...
           echo '<br>';
            ...
            echo 'http://151.106.17.246:8080/hascolbridgeApis/services/get_dealer_ledger.php?sap='.$sap.'' . '<br>';

            $url = 'http://151.106.17.246:8080/hascolbridgeApis/services/get_dealer_ledger.php?sap=' . $sap . ''; // Replace '...' with the provided data string
