        ...
        if (in_array($file_ext, $allowed_ext)) {
            ...
            if ($file_size <= 134217728) { // 128 MB in bytes
                ...
                if (move_uploaded_file($file_loc, $file_path)) {
                    ...
                    $query_main = "INSERT INTO `survey_response_files` 
                    (`category_id`, `inspection_id`, `question_id`, `file`, `dealer_id`, `created_at`, `created_by`) 
                    VALUES ('$category_id', '$inspection_id', '$question_id', '$new_file_name', '$dealer_id', '$tdate', '$user_id');";
