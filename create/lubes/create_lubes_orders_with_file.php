...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $file = rand(1000, 100000) . "-" . $_FILES['invoice_img']['name'];
    ...
    $query_main = "INSERT INTO `lubes_order_main` 
        (`dealer_id`, `total_amount`, `created_at`, `created_by`,`json_data`,`file`) 
        VALUES ('$dealer_id', '$total', '$datetime', '$user_id','$response','$file')";
